...
async function shoutout(sym, from_broadcaster_id, to_broadcaster_id, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        request(`${urls._url("twitch", "shoutouts")}${joinUrlQuery(["moderator_id", "from_broadcaster_id", "to_broadcaster_id"], [moderator_id, from_broadcaster_id, to_broadcaster_id], true)}`, { headers: urls.twitch._headers(sym, customtoken, clientid), method: urls.twitch.shoutouts.method }, (e, r) => {
