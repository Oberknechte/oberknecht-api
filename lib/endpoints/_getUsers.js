...
/** @param {Symbol} sym @param {Array?} logins @param {Array?} ids @param {Boolean?} noautofilterids Prevent filtering of number entries (ids) in logins @param {String?} customtoken */
async function _getUsers(sym, logins, ids, noautofilterids, customtoken) {
