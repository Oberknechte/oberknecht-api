...
async function whisper(sym, from_user_id, to_user_id, message, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        request(`${urls._url("twitch", "whispers")}${joinUrlQuery(["from_user_id", "to_user_id"], [from_user_id, to_user_id], true)}`, { method: urls.twitch.whispers.method, headers: urls.twitch._headers(sym, customtoken, clientid), body: JSON.stringify(reqbody) }, (e, r) => {
