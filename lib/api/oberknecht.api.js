...
const getChannelFollowers = require("../endpoints/getChannelFollowers");
...
const fs = require("fs");
const addEventsubSubscription = require("../endpoints/addEventsubSubscription");
const getEventsubSubscriptions = require("../endpoints/getEventsubSubscriptions");
const deleteEventsubSubscription = require("../endpoints/deleteEventsubSubscription");
const getBroadcasterSubscriptions = require("../endpoints/getBroadcasterSubscriptions");
...
class oberknechtAPI {
    ...
    _getUsers = (logins, ids, noautofilterids, customtoken) => { return _getUsers(this.symbol, logins, ids, noautofilterids, customtoken) };
    ...
    getUsers = (logins, ids, noautofilterids, customtoken) => { return getUsers(this.symbol, logins, ids, noautofilterids, customtoken) };
    ...
    /** @param {"blue" | "green" | "orange" | "purple" | "primary"} color */
    ...
    raid = (from_broadcaster_id, to_broadcaster_id, customtoken) => { return raid(this.symbol, from_broadcaster_id, to_broadcaster_id, customtoken) };
    cancelraid = (broadcaster_id, customtoken) => { return cancelraid(this.symbol, broadcaster_id, customtoken) };
    unraid = this.cancelraid;

    getChannelFollowers = (broadcaster_id, user_id, customtoken) => { return getChannelFollowers(this.symbol, broadcaster_id, user_id, customtoken) };
    addEventsubSubscription = (type, version, condition, transport, customtoken) => { return addEventsubSubscription(this.symbol, type, version, condition, transport, customtoken) };
    getEventsubSubscriptions = (customtoken) => { return getEventsubSubscriptions(this.symbol, customtoken) };
    deleteEventsubSubscription = (id, customtoken) => { return deleteEventsubSubscription(this.symbol, id, customtoken) };

    getBroadcasterSubscriptions = (customtoken, user_id, first, after, before) => { return getBroadcasterSubscriptions(this.symbol, customtoken, user_id, first, after, before) };
};
