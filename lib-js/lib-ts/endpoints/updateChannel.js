...
async function updateChannel(sym, channelData, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        ;
        (0, request_1.default)(`${urls_1.urls._url("twitch", "updateChannel")}?broadcaster_id=${broadcaster_id}`, { method: urls_1.urls.twitch.updateChannel.method, headers: urls_1.urls.twitch._headers(sym, customtoken, clientid), body: JSON.stringify(channelData_) }, (e, r) => {
