...
async function unban(sym, broadcaster_id, user_id, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        (0, request_1.default)(`${urls_1.urls._url("twitch", "unban")}?broadcaster_id=${broadcaster_id_}&moderator_id=${moderator_id}&user_id=${user_id_}`, { method: urls_1.urls.twitch.unban.method, headers: urls_1.urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
