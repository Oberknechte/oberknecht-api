...
export declare class oberknechtAPI {
    ...
    _validatetoken: (customToken: string) => Promise<import("../types/endpoints/validateToken").validateTokenResponseOld | import("../types/endpoints/validateToken").validateTokenResponse>;
    _validateRefreshTokenCode: (refreshToken: string, clientID: string, clientSecret: string, redirectURL: string) => Promise<import("../types/endpoints/validateRefreshTokenCode").validateRefreshTokenCodeResponse>;
