...
export declare class oberknechtAPI {
    ...
    _getUsers: (logins: string[] | undefined, ids?: string[] | undefined, noautofilterids?: Boolean, customtoken?: string) => Promise<import("../types/_getUsers")._getUsersResponse>;
    ...
    getColor: (userids: string | string[], customtoken?: string) => Promise<import("../types/endpoints/getColor").getColorResponse>;
