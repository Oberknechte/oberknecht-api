...
export declare class oberknechtAPI {
    ...
    _getDataForAccessToken: (accessToken: string) => any;
    _validateTokenWR: (accessOrRefreshToken?: string) => Promise<import("../types/endpoints/validateToken").validateTokenResponse>;
    ...
    ban: (broadcasterID: string | undefined, targetUserID: string, reason: string, customToken?: string) => Promise<import("../types/endpoints/ban").banResponse>;
    deleteMessage: (broadcasterID: string | undefined, messageID: string, customToken?: string) => Promise<void>;
    delete: (broadcasterID: string | undefined, messageID: string, customToken?: string) => Promise<void>;
    clearChat: (broadcasterID: string | undefined, customToken?: string) => Promise<void>;
    ...
    shoutout: (fromBroadcasterID: string | undefined, toBroadcasterID: string, customToken?: string) => Promise<void>;
    timeout: (broadcasterID: string | undefined, targetUserID: string, duration: number, reason?: string, customToken?: string) => Promise<import("../types/endpoints/ban").banResponse>;
    unban: (broadcasterID: string | undefined, targetUserID: string, customToken?: string) => Promise<void>;
    untimeout: (broadcasterID: string | undefined, targetUserID: string, customToken?: string) => Promise<void>;
    whisper: (toUserID: string, message: string, customToken?: string) => Promise<void>;
    announce: (broadcasterID: string | undefined, message: string, color: announcementColorsType, customToken?: string) => Promise<void>;
    updateChatSettings: (broadcasterID: string | undefined, settings: chatSettingEntry, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    slow: (broadcasterID: string | undefined, waitTime: number, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    slowOff: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    followers: (broadcasterID: string | undefined, duration?: number, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    followersOff: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    subscribers: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    subscribersOff: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    emote: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    emoteOnly: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    emoteOff: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    emoteOnlyOff: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    r9k: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    uniqueChat: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    r9kOff: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    uniqueChatOff: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    chatdelay: (broadcasterID: string | undefined, duration: number | 2 | 4 | 6, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    chatdelayOff: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    getChatSettings: (broadcasterID: string | undefined, customToken?: string) => Promise<import("../types/endpoints/chatSettings").chatSettingsResponse>;
    ...
    createClip: (broadcasterID: string | undefined, hasDelay?: boolean) => Promise<import("../types/endpoints/createClip").createClipResponse>;
