...
async function getChannels(sym, broadcaster_ids, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        ;
        (0, oberknecht_request_1.request)(`${urls_1.urls._url("twitch", "getChannels")}${(0, oberknecht_utils_1.joinUrlQuery)("broadcaster_id", broadcaster_ids_, true)}`, { headers: urls_1.urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
