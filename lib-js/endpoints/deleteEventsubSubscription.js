...
async function deleteEventsubSubscription(sym, id, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        ;
        (0, oberknecht_request_1.request)(`${urls_1.urls._url("twitch", "deleteEventsubSubscription")}${(0, oberknecht_utils_1.joinUrlQuery)("id", id, true)}`, { method: urls_1.urls.twitch.deleteEventsubSubscription.method, headers: urls_1.urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
