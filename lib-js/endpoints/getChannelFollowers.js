...
async function getChannelFollowers(sym, broadcasterID, userID, customToken) {
    ...
    return new Promise(async (resolve, reject) => {
        (0, oberknecht_request_1.request)(`${urls_1.urls._url("twitch", "channelFollowers")}${(0, oberknecht_utils_1.joinUrlQuery)(["broadcaster_id", "user_id"], [broadcasterID_, userID_], true)}`, {
