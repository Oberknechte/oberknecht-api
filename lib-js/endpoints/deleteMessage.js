...
async function deleteMessage(sym, broadcasterID, messageID, customToken) {
    ...
    return new Promise(async (resolve, reject) => {
        (0, oberknecht_request_1.request)(`${urls_1.urls._url("twitch", "deleteMessage")}${(0, oberknecht_utils_1.joinUrlQuery)(["broadcaster_id", "moderator_id", "message_id"], [broadcasterID_, moderatorID, messageID], true)}`, {
