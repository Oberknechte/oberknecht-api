...
async function getPolls(sym, id, first, after, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        ;
        (0, request_1.default)(`${urls_1.urls._url("twitch", "getPolls")}${(0, oberknecht_utils_1.joinUrlQuery)(["broadcaster_id", "id", "first", "after"], [broadcaster_id, id, first, after], true)}`, { headers: urls_1.urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
