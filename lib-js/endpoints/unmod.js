...
async function unmod(sym, broadcasterID, userID, customToken) {
    ...
    return new Promise(async (resolve, reject) => {
        (0, oberknecht_request_1.request)(`${urls_1.urls._url("twitch", "unmod")}${(0, oberknecht_utils_1.joinUrlQuery)(["broadcaster_id", "user_id"], [broadcasterID_, userID_], true)}`, {
