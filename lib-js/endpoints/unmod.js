...
async function unmod(sym, broadcaster_id, user_id, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        (0, request_1.default)(`${urls_1.urls._url("twitch", "unmod")}?broadcaster_id=${broadcaster_id_}&user_id=${user_id_}`, { method: urls_1.urls.twitch.unmod.method, headers: urls_1.urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
