...
async function vip(sym, user_id, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        ;
        (0, oberknecht_request_1.request)(`${urls_1.urls._url("twitch", "vip")}?broadcaster_id=${broadcaster_id_}&user_id=${user_id_}`, { method: urls_1.urls.twitch.vip.method, headers: urls_1.urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
