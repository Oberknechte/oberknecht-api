...
async function cancelraid(sym, broadcaster_id, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        (0, oberknecht_request_1.request)(`${urls_1.urls._url("twitch", "cancelraid")}?broadcaster_id=${broadcaster_id_}`, { method: urls_1.urls.twitch.cancelraid.method, headers: urls_1.urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
