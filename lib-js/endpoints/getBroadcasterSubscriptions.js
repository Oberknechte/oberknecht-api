...
async function getBroadcasterSubscriptions(sym, customtoken, user_id, first, after, before) {
    return new Promise(async (resolve, reject) => {
        ...
        ;
        (0, oberknecht_request_1.request)(`${urls_1.urls._url("twitch", "getBroadcasterSubscriptions")}${(0, oberknecht_utils_1.joinUrlQuery)(["broadcaster_id", "user_id", "first", "after", "before"], [broadcaster_id_, user_id_, first, after, before], true)}`, { headers: urls_1.urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
