...
async function whisper(sym, to_user_id, message, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        (0, oberknecht_request_1.request)(`${urls_1.urls._url("twitch", "whispers")}${(0, oberknecht_utils_1.joinUrlQuery)(["from_user_id", "to_user_id"], [from_user_id_, to_user_id_], true)}`, { method: urls_1.urls.twitch.whispers.method, headers: urls_1.urls.twitch._headers(sym, customtoken, clientid), body: JSON.stringify(reqbody) }, (e, r) => {
