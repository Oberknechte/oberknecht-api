...
async function getChatSettings(sym, broadcaster_id, customtoken) {
    return new Promise(async (resolve, reject) => {
        ...
        (0, request_1.default)(`${urls_1.urls._url("twitch", "getchatsettings")}?broadcaster_id=${broadcaster_id_}&moderator_id=${moderator_id}`, { headers: urls_1.urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
