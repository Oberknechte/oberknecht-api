...
export async function vip(sym: string, user_id: string, customtoken?: string) {
    return new Promise<void>(async (resolve, reject) => {
        ...
        request(`${urls._url("twitch", "vip")}?broadcaster_id=${broadcaster_id_}&user_id=${user_id_}`, { method: urls.twitch.vip.method, headers: urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
