...
export async function shoutout(sym: string, from_broadcaster_id: string | undefined, to_broadcaster_id: string, customtoken?: string) {
    return new Promise<void>(async (resolve, reject) => {
        ...
        request(`${urls._url("twitch", "shoutouts")}${joinUrlQuery(["moderator_id", "from_broadcaster_id", "to_broadcaster_id"], [moderator_id, from_broadcaster_id_, to_broadcaster_id_], true)}`, { headers: urls.twitch._headers(sym, customtoken, clientid), method: urls.twitch.shoutouts.method }, (e, r) => {
