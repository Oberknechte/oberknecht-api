...
export async function announce(sym: string, broadcaster_id: string | undefined, message: string, color?: announcementColorsType /** @default color "primary" */, customtoken?: string) {
    return new Promise<void>(async (resolve, reject) => {
        ...
        request(`${urls._url("twitch", "announcement")}?broadcaster_id=${broadcaster_id_}&moderator_id=${moderator_id}`, { method: urls.twitch.announcement.method, headers: urls.twitch._headers(sym, customtoken, clientid), body: JSON.stringify(reqbody) }, (e, r) => {
