...
export async function _getUsers(sym: string, logins?: string | string[], ids?: string | string[], noautofilterids?: Boolean /* Prevent filtering of number entries (ids) in logins */, customtoken?: string) {
    return new Promise<_getUsersResponse>(async (resolve, reject) => {
        ...
        if ((!(logins ?? undefined) && !(ids ?? undefined))) return reject(Error("logins and ids is undefined"));
