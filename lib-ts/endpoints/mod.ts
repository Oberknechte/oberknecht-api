...
export async function mod(sym: string, user_id: string, customtoken?: string) {
    return new Promise<void>(async (resolve, reject) => {
        ...
        request(`${urls._url("twitch", "mod")}?broadcaster_id=${broadcaster_id_}&user_id=${user_id_}`, { method: urls.twitch.mod.method, headers: urls.twitch._headers(sym, customtoken, clientid) }, (e, r) => {
