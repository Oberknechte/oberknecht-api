...
export class oberknechtAPI {
    ...
    constructor(options: oberknechtAPIOptionsType) {
        ...
        if (options.saveIDs) {
            ...
            if (!fs.existsSync(options.startPath) || Object.keys(userssplitter._mainpaths).length === 0) {
        ...
        return new Promise<void>(async (resolve) => {
            ...
            await _validatetoken(this._options.token)
                .then(t => {
                    ...
                    if (isdebug(this.symbol, 2)) _log(1, `${_stackname("Oberknecht-API")[3]} Logged in as ${t.login} (${t.user_id})`);
                });
    ...
    deleteMessage = (broadcaster_id: string, message_id: string, customtoken?: string) => { return deleteMessage(this.symbol, broadcaster_id, message_id, customtoken) };
    delete = this.deleteMessage;
    clearChat = (broadcaster_id: string, customtoken?: string) => { return deleteMessage(this.symbol, broadcaster_id, undefined, customtoken) };
    getUsers = (logins: string | string[], ids: string | string[], noautofilterids: boolean, customtoken?: string) => { return getUsers(this.symbol, logins, ids, noautofilterids, customtoken) };
    shoutout = (from_broadcaster_id: string, to_broadcaster_id: string, customtoken?: string) => { return shoutout(this.symbol, from_broadcaster_id, to_broadcaster_id, customtoken) };
    timeout = (broadcaster_id: string, target_user_id: string, duration: string, reason?: string, customtoken?: string) => { return timeout(this.symbol, broadcaster_id, target_user_id, duration, reason, customtoken) };
    unban = (broadcaster_id: string, target_user_id: string, customtoken?: string) => { return unban(this.symbol, broadcaster_id, target_user_id, customtoken) };
    untimeout = this.unban;
    whisper = (to_user_id: string, message: string, customtoken: string) => { return whisper(this.symbol, to_user_id, message, customtoken) };

    announce = (broadcaster_id: string, message: string, color: announcementColorsType, customtoken?: string) => { return announce(this.symbol, broadcaster_id, message, color, customtoken) };
    updateChatSettings = (broadcaster_id: string, settings: chatSettingEntry, customtoken?: string) => { return updateChatSettings(this.symbol, broadcaster_id, settings, customtoken) };

    slow = (broadcaster_id: string, wait_time: number, customtoken?: string) => { return updateSingleChatSetting.slow(this.symbol, broadcaster_id, wait_time, customtoken) };
    slowOff = (broadcaster_id: string, customtoken?: string) => { return updateSingleChatSetting.slowOff(this.symbol, broadcaster_id, customtoken) };

    followers = (broadcaster_id: string, duration?: number, customtoken?: string) => { return updateSingleChatSetting.followers(this.symbol, broadcaster_id, duration, customtoken) };
    followersOff = (broadcaster_id: string, customtoken?: string) => { return updateSingleChatSetting.followersOff(this.symbol, broadcaster_id, customtoken) };

    subscribers = (broadcaster_id: string, customtoken?: string) => { return updateSingleChatSetting.subscribers(this.symbol, broadcaster_id, customtoken) };
    subscribersOff = (broadcaster_id: string, customtoken?: string) => { return updateSingleChatSetting.subscribersOff(this.symbol, broadcaster_id, customtoken) };

    emote = (broadcaster_id: string, customtoken?: string) => { return updateSingleChatSetting.emote(this.symbol, broadcaster_id, customtoken) };
    emoteOnly = this.emote;
    emoteOff = (broadcaster_id: string, customtoken?: string) => { return updateSingleChatSetting.emoteOff(this.symbol, broadcaster_id, customtoken) };
    emoteOnlyOff = this.emoteOff;

    r9k = (broadcaster_id: string, customtoken?: string) => { return updateSingleChatSetting.r9k(this.symbol, broadcaster_id, customtoken) };
    uniqueChat = this.r9k;
    r9kOff = (broadcaster_id: string, customtoken?: string) => { return updateSingleChatSetting.r9kOff(this.symbol, broadcaster_id, customtoken) };
    uniqueChatOff = this.r9kOff;

    chatdelay = (broadcaster_id: string, duration: 2 | 4 | 6, customtoken?: string) => { return updateSingleChatSetting.chatdelay(this.symbol, broadcaster_id, duration, customtoken) };
    chatdelayOff = (broadcaster_id: string, customtoken?: string) => { return updateSingleChatSetting.chatdelayOff(this.symbol, broadcaster_id, customtoken) };

    getChatSettings = (broadcaster_id: string, customtoken?: string) => { return getChatSettings(this.symbol, broadcaster_id, customtoken) };
    getStreams = (filters: getStreamsFiltersType, customtoken?: string) => { return getStreams(this.symbol, filters, customtoken) };

    mod = (user_id: string, customtoken?: string) => { return mod(this.symbol, user_id, customtoken) };
    unmod = (broadcaster_id: string | undefined, user_id: string, customtoken?: string) => { return unmod(this.symbol, broadcaster_id, user_id, customtoken) };

    vip = (to_user_id: string, customtoken?: string) => { return vip(this.symbol, to_user_id, customtoken) };
    unvip = (broadcaster_id: string | undefined, user_id: string, customtoken?: string) => { return unvip(this.symbol, broadcaster_id, user_id, customtoken) };

    updateColor = (color: colorsType, customtoken?: string) => { return updateColor(this.symbol, color, customtoken) };
    getColor = (userids: string | string[], customtoken?: string) => { return getColor(this.symbol, userids, customtoken) };

    raid = (from_broadcaster_id: string | undefined, to_broadcaster_id: string, customtoken?: string) => { return raid(this.symbol, from_broadcaster_id, to_broadcaster_id, customtoken) };
    cancelraid = (broadcaster_id: string | undefined, customtoken?: string) => { return cancelraid(this.symbol, broadcaster_id, customtoken) };
    unraid = this.cancelraid;

    getChannelFollowers = (broadcaster_id?: string, user_id?: string, customtoken?: string) => { return getChannelFollowers(this.symbol, broadcaster_id, user_id, customtoken) };
    addEventsubSubscription = (type: eventsubSubscriptionTypesType, version: eventsubSubscriptionVersionType, condition: any, transport: any, customtoken?: string) => { return addEventsubSubscription(this.symbol, type, version, condition, transport, customtoken) };
